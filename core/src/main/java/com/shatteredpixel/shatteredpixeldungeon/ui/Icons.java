...
public enum Icons {
	...
	public static Image get( Icons type ) {
		...
		switch (type) {
			...
			case MINI_INFO:
				...
				break;
			case MINI_UNCHECKED:
				icon.frame( icon.texture.uvRectBySize( 40, 128, 7, 7 ) );
				break;
			case MINI_CHECKED:
				icon.frame( icon.texture.uvRectBySize( 32, 136, 7, 7 ) );
				break;
			case DEPTH:
			...
			case ENERGY_SML:
				...
				break;
			case BULLET_SML:
				icon.frame( icon.texture.uvRectBySize( 32, 128, 7, 7 ) );
				break;
			case BACKPACK:
	...
	public static Image get( HeroClass cl ) {
		switch (cl) {
			...
			case SAMURAI:
				return new ItemSprite(ItemSpriteSheet.SHEATH);
			case ADVENTURER:
